...
- не содержит Dockerfile;
- не публикуется как контейнер;
...
2. добавить сборку контейнера;
3. добавить публикацию контейнера в GitHub Container Registry;
4. убрать блокировки из hot path поиска через immutable snapshot;
5. добавить сохранение и восстановление индекса;
6. добавить настройки сервиса через конфигурацию.
