...
2. добавить ручную перестройку индекса по имени источника данных;
3. исследовать мониторинг изменений в БД для актуализации индекса;
4. добавить базовую защиту API;
5. расширить нагрузочные проверки сервиса до полноценного benchmark/high-load сценария;
6. добавить документацию по production-развёртыванию контейнера.
