...
- умеет показывать настроенные профили источников данных, но пока не строит индекс из БД;
...
1. добавить построение индекса по имени заранее настроенного источника данных;
