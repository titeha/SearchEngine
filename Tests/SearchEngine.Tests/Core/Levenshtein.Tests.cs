...
public class LevenshteinTests
{
  ...
  {
    Assert.Equal(0, Search<int>.Levenshtein.DistanceLeventstein("", ""));
  }
  ...
  {
    Assert.Equal(expected, Search<int>.Levenshtein.DistanceLeventstein("", target));
  }
  ...
  public void Test_SameStrings(string str)
  {
    ...
    Assert.Equal(0, Search<int>.Levenshtein.DistanceLeventstein(str, str));
  }
  ...
  {
    Assert.Equal(expected, Search<int>.Levenshtein.DistanceLeventstein(source, target));
  }
