...
параллельной обработки, чтобы не увеличивать давление на память на небольших
и средних наборах данных.

Для серверных сценариев, где важнее скорость построения индекса, можно включить
параллельную обработку явно:
